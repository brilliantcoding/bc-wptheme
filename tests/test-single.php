...
<blockquote>Does an announcement about the future of Java EE excite you? - Drop your comments in the discussion below.<footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer></blockquote>
...
$data['categories'] = Array(
	0 => Array(
		...
		'cat_name' => 'Code Refactor',
		'category_nicename' => 'code-refactor',
		'category_parent' => 0,
		'url' => 'http://localhost:32771/category/code-refactor/',
	),
	1 => Array
	(
		'term_id' => 11,
		...
		'category_count' => 1,
		'category_description' => '',
		'cat_name' => 'Developer Tools',
		'category_nicename' => 'developer-tools',
		'category_parent' => 0,
		'url' => 'http://localhost:32771/category/developer-tools/',
	),
	2 => Array(
		'term_id' => 24,
		'name' => 'Notes from the Dev',
		'slug' => 'notes-from-the-dev',
		'term_group' => 0,
		'term_taxonomy_id' => 24,
		'taxonomy' => 'category',
		'description' => '',
		...
		'category_count' => 1,
		'category_description' => '',
		'cat_name' => 'Notes from the Dev',
		'category_nicename' => 'notes-from-the-dev',
		'category_parent' => 0,
		'url' => 'http://localhost:32771/category/notes-from-the-dev/',
	),
);
